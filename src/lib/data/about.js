// Shared content for the About section — used by both the /about route page
// and the in-menu AboutOverlay so the prose lives in one place.
...
export const PARAS = [
  ...
  "Through a clean, user-centric experience, we challenge you to look past the scoreboard and think critically about the role of the athletes, in a world that often demands their silence.",
]
